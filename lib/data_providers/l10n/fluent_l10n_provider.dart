// === Locate应用 引用依赖的三层次
//底层引擎层dart:ui绘图、窗口、字体、Locale等系统信息
// import 'dart:ui';
// UI 框架层widgets.dart Widget体系（StatelessWidget、BuildContext等）
import 'package:flutter/widgets.dart';
// Material层 material.dart Material Design 风格UI组件
// import 'package:flutter/material.dart';

// 在pubspec.yaml中配置依赖 fluent
...
class FluentL10NProvider extends L10NProvider{
  // Fluent 是mozilla出品的国际化系统
  final FluentBundle _bundle;
  final List<Error> _errors = [];

  // dart语法糖 构造函数：FluentL10NProvider._internal(FluentBundle bundle) {
  //   this._bundle = bundle;
  // }
  FluentL10NProvider._internal(this._bundle);//声明一个构造函数
  ...
  static Future<FluentL10NProvider> load(Locale locale) async{
    ...
    return FluentL10NProvider._internal(bundle);//调用阶段 根据上面定义的构造函数创建一个FluentL10NProvider的实例
  }
